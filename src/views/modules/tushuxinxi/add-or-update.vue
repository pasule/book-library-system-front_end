  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-form-item label="标签" prop="tags">
        <el-input v-model="ruleForm.tags" placeholder="多个标签用逗号分隔,如:历史,科技,文学"></el-input>
      </el-form-item>
...
export default {
  data() {
	...
	clicknum : false,
            ...
            ruleForm: {
                  ...
                  tags: [
                    { required: false, message: '请输入标签,多个用逗号分隔', trigger: 'blur' }
                  ]
              }
    };
  },
  ...
  methods: {
	...
	this.ruleForm.tushujianjie = this.ruleForm.tushujianjie.replace(reg,'../../../springboot33dng/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
